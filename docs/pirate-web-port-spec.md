...
- Web `/submit` can become a native community picker plus composer flow.
...
- support native create-post flows from both community and global entry points
